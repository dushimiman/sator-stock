...
function viewReturnedItems($mysqli, $search = '') {
    $sql = "SELECT * FROM returned_items WHERE is_working = 0";
    
    if (!empty($search)) {
        $sql .= " AND (serial_number LIKE '%$search%' OR returned_by LIKE '%$search%' OR return_reason LIKE '%$search%' OR creation_date LIKE '%$search%')";
    }
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<tr><th>ID</th><th>Item Name</th><th>Serial Number</th> <th>IMEI</th><th>Returned By</th><th>Return Reason</th><th>Return Date</th><th>Actions</th></tr>";
        echo "</thead>";
        echo "<tbody>";
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php
                            viewReturnedItems($mysqli, $search);
                        ?>
                    </div>
                </div>
            </div>
