<?php
include(__DIR__ .'/../TCPDF-main/tcpdf.php');
...
$sql_stock_daily = "SELECT item_type, SUM(quantity) AS total_quantity 
                    ...
                    GROUP BY item_type";
$result_stock_daily = $mysqli->query($sql_stock_daily);
